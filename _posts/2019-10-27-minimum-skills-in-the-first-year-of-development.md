...
我们还需要逐渐掌握语法。编程语言的语法不难，如果英语的语法难度系数是 100，那编程语言基础的语法就相当于 5 这个高度。因为编程语言的基础语法就来自于生活。
...
第一个场景是如果...那么...巨型，即只有满足了某个条件，才可以完成下面某个动作；反之，不满足条件，则后面的动作无法执行；

第二个场景是翻来覆去巨型，即同样的动作，被重复执行。

编程语言也是语言，编程语言来自于生活，任何编程语言，基本都具备这两个语法。

用编程语言来说，第一个场景是if...else...，第二个场景是 for 循环。
