...
第三次工业革命多称为第三次科技革命，始于上世纪五十年代，进行中，未来到哪个时间点结束我们还无从知道。
...
计算机、手机都是第三次科技革命的产物。首先他们是机器，需要人操作，这是跟汽车、挖掘机的相同之处；其次，计算机、手机支持算数运算、逻辑判断，同时还具有存储功能，这是跟汽车、挖掘机的不同之处。
...
你左打方向盘，汽车左转，右打右转，这种就是用简单的机械方式操作了汽车这一机器；不过如果是台自动驾驶汽车，遇到某种情况，它会自动的左打方向盘，这就高级了，为什么？因为机器做了判断，判断的过程是：
...
Python 是一门非常适合初学者计算机编程语言。

其实世界上有非常多种的编程语言，不过很多编程语言哪，一开始配置开发环境的时候就让人搞得头大。

Java 也不错，不过自学的话，并且是刚刚入门，学习的难度有些大，要是有个人手把手教，就好了。

我还是推荐 Python。学习 Python 你不需要报这个培训班那个培训班，网上有很多免费的视频教学资料，一个课时一个课时跟着来，课后勤加练习，如此两个月，持续精进，入门不是问题。
...
这里我还是以推荐视频为准，鸟哥的《Linux私房菜》固然好，但书籍对初级选手毕竟不太友好，我推荐《马哥教育的 Linux 培训课程》，不用全上完，上一半就基本够用了。

#### Git命令行使用

21 世纪的第二个十年，绝大多数的软件项目都在使用 Git 作为版本管理工具。

还是那句话，假如你志于将来从事软件研发的行业，操作系统、Git 最好学一学；如果你只是想满足一下软件研发的好奇心，你就老老实实的把 Python 学习好，就够了。
...
我的操作系统是英文的，我的 Android 系统是英文的，我强迫自己看英文新闻,比如 SCMP、Reddit...
...
拿董明珠代言的格力空调为例。格力集团，大厂商、大牌子，假如它所有空调全部自己生产自己销售，排场非常大对吧，它一定有自己的上下游关系。
