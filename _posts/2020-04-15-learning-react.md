...
一开始我对 JavaScript 的印象不是很好，因为我总要判断某个值到底是不是 undefined 我才敢放心使用，在获取可能是数组对象的第一个值时尤其要注意，一不留神就给你返回一个大大的 undefined。刚入手 JavaScript 的时候，我觉得这门编程语言滑溜的简直像小时候挽着裤脚在河里逮的泥鳅，给我带来特别大的不适感。不过这样的挫败感只折磨了我半个月的时间，当我读完 <a href="/2019/12/25/after-reading-professional-js-for-web-devs">《 JavaScript 高级程序设计》</a> 后，我很快接受了这门语言，后来项目迁移到带类型标注的 TypeScript，我没有感觉到任何额外的学习成本。
